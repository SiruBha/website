...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const linkedinLogo = document.querySelector('img[alt="calling logo"]');
  const emailLogo = document.querySelector('img[alt="email logo"]');

  const lightLogos = {
    github: "assets/github_light.png",
    calling: "assets/phone_light.png",
  ...
  function setTheme(isDark) {
    ...
    linkedinLogo.src = isDark ? darkLogos.calling : lightLogos.calling;
